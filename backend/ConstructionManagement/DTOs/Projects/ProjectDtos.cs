...
namespace ConstructionManagement.DTOs.Projects
{
    ...
    /// <summary>
    /// Optional request payload used to generate an AI weekly project summary.
    /// </summary>
    public class AiWeeklySummaryRequestDto
    {
        /// <summary>
        /// Optional free-form notes from the PM, such as site observations or meeting context.
        /// </summary>
        [MaxLength(4000)]
    ...
    /// <summary>
    /// Structured weekly summary generated by the AI assistant for a project.
    /// </summary>
    public class AiWeeklySummaryDto
    {
        public string Headline { get; set; } = string.Empty;

        public string Summary { get; set; } = string.Empty;

        public List<string> ProgressHighlights { get; set; } = [];

        public List<string> RiskAlerts { get; set; } = [];

        public List<string> NextWeekPlan { get; set; } = [];

        public List<string> OpenDecisions { get; set; } = [];
    }
